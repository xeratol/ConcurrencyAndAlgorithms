...
BMP::BMP(BMP&& other)
{
    ...
    SizeOfMetaData1 = other.SizeOfMetaData1;
    MetaData2 = other.MetaData2;
    SizeOfMetaData2 = other.SizeOfMetaData2;

    other.Width = 1;
    other.Height = 1;
    other.BitDepth = 24;
    other.Pixels = new RGBApixel*[Width];
    other.Pixels[0] = new RGBApixel[Height];
    other.Colors = NULL;

    other.XPelsPerMeter = 0;
    other.YPelsPerMeter = 0;

    other.MetaData1 = NULL;
    other.SizeOfMetaData1 = 0;
    other.MetaData2 = NULL;
    other.SizeOfMetaData2 = 0;
}
...
const RGBApixel* BMP::operator()(int i, int j) const
{
    using namespace std;
    bool Warn = false;
    if (i >= Width)
...
bool BMP::SetSize(int NewWidth, int NewHeight, RGBApixel color)
{
    using namespace std;
